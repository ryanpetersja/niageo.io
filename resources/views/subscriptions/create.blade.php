                ...
                <form method="POST" action="{{ route('subscriptions.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="billing_cycle" id="billing_cycle" required
                                ...
                                @foreach(\App\Models\SubscriptionBill::BILLING_CYCLES as $key => $label)
                                    <option value="{{ $key }}" {{ old('billing_cycle', 'monthly') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="next_due_date" id="next_due_date" value="{{ old('next_due_date') }}" required
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="url" name="url" id="url" value="{{ old('url') }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                   placeholder="https://cloud.digitalocean.com/billing">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="description" id="description" value="{{ old('description') }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                               placeholder="e.g., 3 droplets + managed DB">
                    ...
                    <div class="mt-4 flex items-center gap-6">
                        ...
                        <label class="inline-flex items-center">
                            ...
                            <input type="checkbox" name="auto_renew" value="1" {{ old('auto_renew', '1') ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                    ...
                    <div class="mt-6 flex justify-end gap-3">
                        ...
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 transition">Add Subscription</button>
                    </div>
                </form>
            </div>
        </div>
